...
//  if (millis() % 1 == 0) {
  ...
  if (lectura[0] >= umbrales[0] && lectura[1] >= umbrales[1] && lectura[2] <= umbrales[2] && lectura[3] >= umbrales[3] && lectura[4] >= umbrales[4]) {

    posicion = 0; //

  } else if (lectura[0] >= umbrales[0] && lectura[1] <= umbrales[1] && lectura[2] >= umbrales[2] && lectura[3] >= umbrales[3] && lectura[4] >= umbrales[4]) {
  ...
  else if (lectura[0] >= umbrales[0] && lectura[1] >= umbrales[1] && lectura[2] >= umbrales[2] && lectura[3] >= umbrales[3]) {
    //
    if (posicion >= 0) {
      posicion = 250;
    } else {
